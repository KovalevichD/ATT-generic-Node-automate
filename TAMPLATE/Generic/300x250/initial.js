...
window.onload = function() {
	...
	function politeInit(){		
		...
		function animate() {
            ...
            .from([text1, text2], 0.5, {y:"-=150", alpha:0, ease:Sine.easeOut}, "st+=0.5")
            
            .to([text1, text2], 0.2, {y:"+=20", alpha:0, ease:Sine.easeIn}, "st+=3.5")
            .from([text3, text4], 0.5, {y:"-=150", alpha:0, ease:Sine.easeOut}, "st+=3.7")
            
            .to([text3, text4], 0.2, {y:"+=20", alpha:0, ease:Sine.easeIn}, "st+=6.5")
            .from(textevent, 0.5, {y:"-=150", alpha:0, ease:Sine.easeOut}, "st+=6.7")
