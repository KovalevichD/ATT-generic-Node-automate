...
window.onload = function() {
	...
	function politeInit(){		
        ...
        if (text5.innerHTML.length > 21) {
            text5.style.fontSize = "13px";
        } 
        
        if (text6.innerHTML.length + text7.innerHTML.length > 26) {
            text6.style.fontSize = "13px";
            text7.style.fontSize = "13px";
            text6.style.lineHeight = "140%";
            text7.style.lineHeight = "140%";
        }
		...
		function animate() {
            ...
            .from([text1, text2], 0.5, {y:"-=50", alpha:0, ease:Sine.easeOut}, "st+=0.5")
            
            .to([text1, text2], 0.2, {y:"+=20", alpha:0, ease:Sine.easeIn}, "st+=3.5")
            .from([text3, text4], 0.5, {y:"-=50", alpha:0, ease:Sine.easeOut}, "st+=3.7")
            
            .to([text3, text4], 0.2, {y:"+=20", alpha:0, ease:Sine.easeIn}, "st+=6.5")
            .from(textevent, 0.5, {y:"-=50", alpha:0, ease:Sine.easeOut}, "st+=6.7")
