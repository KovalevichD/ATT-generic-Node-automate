...
//	    console.log = function() {}
		...
		function animate() {
            ...
            .from(logoitem, {duration:0.8, y:"-=100", ease:"power2"}, "<0.5")
            .from(orangelines, {duration:0.8, x:"+=150", width:0, ease:"power2"}, "<")
            
            .from(logo, {duration:1.2, force3D:true, rotation:0.01, height:125, ease:"power2.inOut"}, ">")
            .from(footer, {duration:1.2, force3D:true, rotation:0.01, height:125, ease:"power2.inOut"}, "<")
            
            .from(slogan, {duration:0.6, y:"+=25", scale:0, alpha:0, ease:"power2"}, "<0.8")
