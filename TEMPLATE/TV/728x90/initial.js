...
//	    console.log = function() {}
        ...
        if (text5.innerHTML.length > 26) {
            text5.style.fontSize = "11px";
        } 
		...
		function animate() {
            ...
            .from(orangelines, {duration:0.8, y:"+=45", height:0, ease:"power2"}, "<")
            
            .from(logo, {duration:1.2, force3D:true, rotation:0.01, width:364, ease:"power2.inOut"}, ">")
            .from(footer, {duration:1.2, force3D:true, rotation:0.01, width:364, ease:"power2.inOut"}, "<")
            
            .from(slogan, {duration:0.6, y:"-=45", scale:0, alpha:0, ease:"power2"}, "<0.8")
