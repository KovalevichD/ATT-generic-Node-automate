		...
		function animate() {
            ...
            var total = 60, k = 0,
             ...
             for (var i = 0, div; i < total; i++) { 
                ...
                TweenMax.set(div, {x:R(0,w), y:R(-100, 100), opacity:1, scale:R(0,0.5)+0.5, backgroundColor:"hsl(" +R(0,200)+ ",80%,50%)"});
                animm(div);
             }
            ...
            .from([text1, text2], 0.5, {y:"-=200", alpha:0, ease:Sine.easeOut}, "st+=0.5")
            
            .to([text1, text2], 0.2, {y:"+=20", alpha:0, ease:Sine.easeIn}, "st+=3.5")
            .from([text3, text4], 0.5, {y:"-=200", alpha:0, ease:Sine.easeOut}, "st+=3.7")
            
            .to([text3, text4], 0.2, {y:"+=20", alpha:0, ease:Sine.easeIn}, "st+=6.5")
            .from(textevent, 0.5, {y:"-=200", alpha:0, ease:Sine.easeOut}, "st+=6.7")
